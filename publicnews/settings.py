...
SECRET_KEY = 'django-insecure-p5tl$^gru)-)a9lz#5070vj@@=en*!kto$o8+mk($6mfbm&)47'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'news.context_processors.social_media_links', 
            ],
        },
    },
]
...
# If you don't have a 'home' page, use any other existing URL pattern name.
